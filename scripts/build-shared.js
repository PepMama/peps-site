...
const site = {
  ...
  appUrl: 'https://app.prepapeps.com/',
  author: 'PREPA’PEPS - Le mouvement, sixième sens de l’être humain',
  keywords:
    'Coach sportif, préparation physique, suivi athlétique, remise en forme, sport collectif, sport individuel',
...
const pages = [
  {
    ...
    description:
      'PREPA’PEPS, le mouvement, sixième sens de l’être humain, accompagne ses clients dans leur accomplissement sportif avec proximité, adaptabilité et partage.',
  ...
  },
  {
    ...
    description:
      "Découvrez l'ADN de PREPA’PEPS, une structure dédiée au mouvement et à la performance sportive, centrée sur l'adaptabilité, la proximité et le partage.",
  ...
  },
  {
    ...
    description:
      "Découvre l'accompagnement sportif sur mesure proposé par PREPA’PEPS : préparation athlétique, réathlétisation, remise en forme, bien-être et mobilité durable.",
  ...
  },
  {
    ...
    description:
      "Découvrez comment PREPA’PEPS vous accompagne à travers des étapes clés pour atteindre vos objectifs sportifs : suivi personnalisé, tests et plans d'entraînement adaptés.",
  ...
  },
  {
    ...
    description:
      'Contactez PREPA’PEPS pour échanger sur un accompagnement sportif, une préparation physique ou une remise en forme personnalisée.',
  ...
  },
  {
    ...
    description:
      'Mentions légales du site PREPA’PEPS, le mouvement, sixième sens de l’être humain.',
...
function appLink(className) {
  const pending = site.appUrl === '#' ? ' aria-disabled="true" title="Lien app prepapeps"' : '';
...
for (const page of pages) {
  ...
  if (isHome) {
    html = html.replace(/<a class="btn home-space"[\s\S]*?<\/a>/, appLink('btn home-space'));
  } else {
    html = html.replace(
